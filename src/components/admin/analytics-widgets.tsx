...
export function TopProductList({
  ...
  return (
    <article className="trend-list-card" style={{ height: "100%", background: "var(--surface-strong)", color: "var(--foreground)", border: "1px solid var(--line)", borderRadius: 12, padding: "20px 24px" }}>
      <div className="trend-list-head" style={{ display: "flex", justifyContent: "space-between", marginBottom: 20 }}>
        <div>
          ...
          <h3 style={{ margin: 0, fontSize: "1.25rem", color: "var(--foreground)" }}>{title}</h3>
        </div>
      ...
      {products.length ? (
            ...
            <div className="trend-product-item" key={product.code} style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <div className="trend-product-main" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div>
                  ...
                  <span style={{ fontSize: "0.8rem", color: "var(--muted)" }}>{product.code}</span>
                </div>
                <span className="trend-delta-chip is-neutral" style={{ fontWeight: "700", background: "var(--line)", padding: "4px 8px", borderRadius: 999, fontSize: "0.75rem" }}>
                  {product.count} {metricLabel}
                </span>
              </div>
              <div className="trend-progress-track" style={{ height: 6, background: "var(--line)", borderRadius: 999, overflow: "hidden" }}>
                <div
        ...
        <div className="trend-empty" style={{ textAlign: "center", padding: "40px 0", color: "var(--muted)" }}>
          <p>{emptyCopy}</p>
        </div>
      )}
    </article>
...
export function QrScansCard({ data }: { data: any }) {
  return (
    <article className="trend-hero-card" style={{ height: "100%", background: "var(--surface-strong)", color: "var(--foreground)", border: "1px solid var(--line)", borderRadius: 12, padding: "20px 24px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
      <div>
        <div className="trend-card-head" style={{ display: "flex", justifyContent: "space-between", marginBottom: 20 }}>
          <div>
            ...
            <h3 style={{ margin: 0, fontSize: "1.25rem", color: "var(--foreground)" }}>Escaneos de Códigos QR</h3>
          </div>
          <span className="trend-icon-chip" style={{ width: 40, height: 40, borderRadius: "50%", background: "rgba(99, 102, 241, 0.1)", color: "var(--brand-primary)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <QrCode size={20} />
          </span>
        ...
        <div className="trend-hero-value" style={{ display: "flex", alignItems: "baseline", gap: 12 }}>
          <strong style={{ fontSize: "2.5rem", color: "var(--foreground)", lineHeight: 1 }}>{formatCompactNumber(data.storeAnalysis.scans.currentValue)}</strong>
          <span
            className={cn(
              "trend-delta-chip",
      ...
      <div style={{ marginTop: "16px", display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "8px" }}>
        <div style={{ padding: "8px", background: "#f8fafc", borderRadius: "8px", display: "flex", flexDirection: "column", gap: "2px" }}>
          <span style={{ fontSize: "10px", color: "var(--muted)", fontWeight: "600" }}>WhatsApp</span>
          <span style={{ fontSize: "14px", fontWeight: "700", color: "var(--foreground)" }}>{data.storeAnalysis.interactions.whatsapp}</span>
        </div>
        <div style={{ padding: "8px", background: "#f8fafc", borderRadius: "8px", display: "flex", flexDirection: "column", gap: "2px" }}>
          <span style={{ fontSize: "10px", color: "var(--muted)", fontWeight: "600" }}>Videos</span>
          <span style={{ fontSize: "14px", fontWeight: "700", color: "var(--foreground)" }}>{data.storeAnalysis.interactions.videoPlay}</span>
        </div>
        <div style={{ padding: "8px", background: "#f8fafc", borderRadius: "8px", display: "flex", flexDirection: "column", gap: "2px" }}>
          <span style={{ fontSize: "10px", color: "var(--muted)", fontWeight: "600" }}>PDFs Abiertos</span>
          <span style={{ fontSize: "14px", fontWeight: "700", color: "var(--foreground)" }}>{data.storeAnalysis.interactions.documentOpen}</span>
        </div>
        <div style={{ padding: "8px", background: "#f8fafc", borderRadius: "8px", display: "flex", flexDirection: "column", gap: "2px" }}>
          <span style={{ fontSize: "10px", color: "var(--muted)", fontWeight: "600" }}>Añadidos Carrito</span>
          <span style={{ fontSize: "14px", fontWeight: "700", color: "var(--foreground)" }}>{data.storeAnalysis.interactions.addToCart}</span>
        </div>
      </div>
    </article>
  );
...
export function QuotesTotalCard({ data }: { data: any }) {
  return (
    <article className="trend-forecast-card" style={{ height: "100%", background: "var(--surface-strong)", color: "var(--foreground)", border: "1px solid var(--line)", borderRadius: 12, padding: "20px 24px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
      <div>
        <div className="trend-card-head" style={{ display: "flex", justifyContent: "space-between", marginBottom: 20 }}>
          <div>
            ...
            <h3 style={{ margin: 0, fontSize: "1.25rem", color: "var(--foreground)" }}>Total Valorizado</h3>
          </div>
          <span className="trend-icon-chip" style={{ width: 40, height: 40, borderRadius: "50%", background: "rgba(99, 102, 241, 0.1)", color: "var(--brand-primary)", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div className="trend-hero-value" style={{ display: "flex", alignItems: "baseline", gap: 12 }}>
          <strong style={{ fontSize: "2.5rem", color: "var(--foreground)", lineHeight: 1 }}>
      ...
      <div style={{ borderTop: "1px solid #f1f5f9", paddingTop: "16px", marginTop: "16px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <p style={{ fontSize: "11px", color: "var(--muted)", margin: 0, fontWeight: "600" }}>Pedidos Solicitados</p>
            <strong style={{ fontSize: "16px", color: "var(--foreground)" }}>{data.storeAnalysis.quotesCount.currentValue}</strong>
          </div>
          <span
            className={cn(
              "trend-delta-chip",
